...
Allowed intents: greeting, stock_inquiry, price_inquiry, product_inquiry, delivery_inquiry, order_status, complaint, order_request, return_request, praise, unknown.
...
- return_request: they want to send something back, swap it, or get their money back. "Can I return this?", "how do exchanges work", "I want a refund", "it doesn't fit, can I swap it". Use this even when they are also unhappy - it can sit alongside complaint.
