...
def _issue_session(user, method='password'):
    ...
    One definition, because there are now two front doors — password and
    emailed one-time code — and the things that happen on the way in are
    security-relevant: the
